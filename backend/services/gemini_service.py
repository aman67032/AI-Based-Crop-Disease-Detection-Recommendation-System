"""
Gemini API service (Google AI Studio) — Secondary AI provider.
Uses google-generativeai SDK for text recommendations and vision analysis.
"""
...
# Gemini via OpenAI-compatible endpoint (Google AI Studio supports this)
client = AsyncOpenAI(
...
async def get_recommendation(
    ...
    """Generate treatment recommendation using Gemini API."""
    lang_instruction = {
...
Generate a clear, simple recommendation. Include:
...
async def analyze_image_with_gemini(image_bytes: bytes, crop_hint: str = "") -> str:
    """Send leaf image to Gemini for visual disease analysis."""
